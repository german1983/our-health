...
const NUTRITION_FIELDS: { key: keyof NutritionalFacts; label: string; unit: string }[] = [
...
const emptyNutritionForm: NutritionFormState = {
  calories: '',
  fat: '',
  saturatedFat: '',
  carbs: '',
...
function formToNutrition(form: NutritionFormState): NutritionalFacts | null {
